...
export function RepoTable({ repositories, onRemove }: RepoTableProps) {
  ...
  return (
    <div className="rounded-xl border border-outline-variant/30 bg-surface-container overflow-hidden">
      {/* Table header */}
      <div className="grid grid-cols-[1fr_2fr_auto] gap-4 px-5 py-3 border-b border-outline-variant/20 bg-surface-container-high">
      ...
      {repositories.map((repo, i) => (
        <div
          key={repo.id}
          className={`grid grid-cols-[1fr_2fr_auto] gap-4 items-center px-5 py-4 ${
