...
6. **Implementation Planning + Skill Generation** — [phase5-implementation-planning.md](phase5-implementation-planning.md)
7. **Execute** — [phase6-execution.md](phase6-execution.md)
