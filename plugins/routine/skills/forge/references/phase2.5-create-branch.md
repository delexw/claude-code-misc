...
- Determine the working repo directory:
  1. If ADDITIONAL_CONTEXT is provided, read it and use your judgment to infer the intended repo path (it may name a project, describe a service, reference a directory, or give any other hint — resolve it to an absolute path on disk)
