...
- Launch a `Task` call with prompt: `Invoke Skill("jira-ticket-viewer") with "{ticket_id} {TICKET_ASSETS_DIR}/jira"` (e.g. `EC-10420 .implement-assets/EC-10420/jira`)
- After the task completes, **read `TICKET_ASSETS_DIR/jira/output.json`** to get the full parsed ticket JSON
